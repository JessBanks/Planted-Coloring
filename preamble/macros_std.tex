...
\linespread{0.9}% Give Palatino more leading (space between lines)
...
\newrefformat{prog}{\savehyperref{#1}{\textup{Program \ref*{#1}}}}
...
\newcommand{\Pnote}{\Authornotecolored{ForestGreen}{P}}
\newcommand{\Mnote}{\Authornotecolored{Blue}{M}}
...
\newcommand{\Bin}{\mathop{\textrm{Bin}}}
\newcommand{\Ber}{\mathop{\textrm{Ber}}}

% {{{ optimization }}}
\newcommand{\sdpval}{\mathsf{sdpval}}
\newcommand{\sos}{{SoS}\xspace }
...
\DeclareMathOperator{\lamax}{\lambda_{max}}

\DeclareMathOperator{\Id}{\mathrm{Id}}
\DeclareMathOperator{\row}{row}
\newcommand{\Perr}{P_{\text{err}}}
...
\newcommand{\sparsepca}{\problemmacro{sparse pca}}
...
\newcommand{\threexor}{\problemmacro{\pnum{3}-xor}}
...
\newcommand{\maxthreexor}{\problemmacro{max \pnum{3}-xor}}
...
\newcommand{\MaxC}{\problemmacro{max clique}}
\newcommand{\plantedclique}{\problemmacro{planted clique}}
\newcommand{\densestksubgraph}{\problemmacro{densest $k$-subgraph}}
\newcommand{\communitydetection}{\problemmacro{community detection}}
...
\newcommand{\restateobs}[1]{%
  % overwrite label command with dummy
  \let\MYoldlabel\label
  \let\label\MYdummylabel
  \begin{observation*}[Restatement of \prettyref{#1}]
    \MYload{#1}
  \end{observation*}
  \let\label\MYoldlabel
}
...
\usepackage[newenum,newitem,increaseonly]{paralist}
\setlength{\pltopsep}{3pt}
\setlength{\plpartopsep}{3pt}
\setlength{\plitemsep}{2.5pt}
...
\newcommand{\restateproblem}[2]{%
  % overwrite label command with dummy
  \let\MYoldlabel\label
  \let\label\MYdummylabel
  \begin{problem*}[Restatement of \prettyref{#1}, {#2}]
    \MYload{#1}
    \end{problem*}
  \let\label\MYoldlabel
}
...
\newcommand{\ovec}{{\mathbbm 1}}
\newcommand{\novec}{\tilde\ovec}

%%% Local Variables:
%%% mode: latex
%%% TeX-master: "../sos-speedups-via-partial-trace"
%%% End:
